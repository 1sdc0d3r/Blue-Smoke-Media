...
export default function PrivacyPolicy() {
  ...
  return (
    <section className="privacy">
      ...
      <pre>
        <h1>PRIVACY NOTICE Last updated September 07, 2020</h1>
...
`}
        <h4 ref={ref5}>5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h4>
...
`}
        <h4 ref={ref6}>6. HOW LONG DO WE KEEP YOUR INFORMATION?</h4>
...
`}
        <h4 ref={ref7}>7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h4>
...
Blue Smoke Digital and Printed Media has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Blue Smoke Digital and Printed Media will not sell personal information in the future belonging to website visitors, users and other consumers.
