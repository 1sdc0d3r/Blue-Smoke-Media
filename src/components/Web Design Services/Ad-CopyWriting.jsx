...
export default function AdCopyWriting() {
  return (
    <div className="ad-copy-writing page-wrapper">
      <img src={AdCopyWritingImg} alt="Creating copy that will allow your clients to envision your product or service." />
      <div className="content">
        ...
        <p>
          ...
          information, properly presented and illustrated, to enable them to
          choose your company, your product or service.
        </p>
        <p>
          ...
          understand this. <span>Blue Smoke Digital Media</span> will help you take that
          “step back” and analyze your site making recommendations about any
        ...
        <p>
          ...
          <span>Blue Smoke Digital Media</span> will help you decide what the critical
