    ...
    <>
      <section className="social-media">
        ...
        <p>
          ...
          people share content quickly, efficiently, and in real-time. While
          many people access social media through smartphone apps, this
          communication tool started with computers, and social media can refer
          to any internet communication tool that allows users to broadly share
        ...
        <p>
          ...
          used to market your products, promote your brand, connect to current
        ...
        <ul>
          <li>
            ◆ Social Media can be a valuable tool as profiles can provide
      ...
      <Helmet>
        ...
        <meta
          itemprop="name"
          content=" Social Media: Why It Is 100% Essential (and How to Use It Well)."
        />
        <meta
