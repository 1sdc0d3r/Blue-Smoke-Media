      ...
      <div className="home">
        <section className="globe">
          <p>
            ...
            ranging from one-person companies, small and medium sized business
            to non-profit organizations. Our websites are fast loading,
        ...
        <section className="social-media">
          <div className="content">
            ...
            <p>
              ...
              However, the best friends and trends usually end up sticking
              around and evolving into a permanent part of our lives with
              qualities such as integrity, dependability, trust, quality and
              even ROI.
            </p>
            <h2>Video Crushes It</h2>
            <p>
              More than 28% of users from four major social media platforms
              engage with live streams each month on any one of these services.
              “Video is the hottest platform on the planet right now and the
              cheapest to distribute through social media,” said{" "}
