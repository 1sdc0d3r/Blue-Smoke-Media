...
export const articleData = [{
    ...
    <span>9. Neglecting to ask the visitor to do something.</span> In marketing, this is known as a Call To Action. There should be a space designated to tell your visitors what you want them to do next. Sign up for my newsletter. Order now.
    ...
    <span>1. Do You Have A Compelling Headline?</span> Does it generate curiosity or envy? Does it promise a benefit that will compel someone with an interest in what you’re selling to keep reading. Remember, your headline is the ad for the ad.When I am being paid to write direct response ad copy, or a sales letter, or have a very important sales objective of my own, I normally write 25 headlines before I begin the body of the piece.Then I’ll pick half a dozen that I think will work & test them. The best of the rest, I use as sub headings throughout the piece to propel readership, and draw skimmers & skippers back into the copy as they move down the page.

    <span>2. Are Your Headlines Pleasing To The Eye?</span> I most often find that headlines work best when they are centered on the page, & present a balanced appearance in terms of the shape they create. Encasing them in quotation marks also serves to grab more attention.Long top headlines tend to reduce readership, but if they help qualify more effectively they can improve sales! Try them, but look for ways to modularize the text using punctuation & spacing so your readers don’t suffocate trying to read them. Sometimes a long top headline is better presented as two or even three separate headlines.

    <span>3. Is Your Opening Provocative & Arresting?</span> Does it trip the reader, interrupting the internal turbulence of the day? Each line of your ad copy must serve to “sell” the reader on continued reading, especially at the beginning.You are looking to build enough momentum & interest to convey the points necessary to generate a greater desire for the product than it’s price. Generally speaking, the higher the cost of the product, the more words required.

    <span>4. Are You FAB Balanced?</span> You must focus on painting a picture of your prospects future life, as a result of their purchase. Does your copy promise emotional benefits? Does it pledge the realization of positive feelings, or the relief of negative ones?Does it show how these outcomes are achieved with concise descriptions of the features & advantages that will deliver them? Your ad copy must strike a balance between emotion & logic if it is to be effect.

    <span>5. Are You Creating Excitement & Enthusiasm?</span> Demonstrate your personal belief in what you are selling. Will your message quicken the readers pulse? Is it upbeat, positive, & full of inspired energy? Is there a sense of WOW?

    <span>6. Is Your Body Copy Highly Readable?</span> Remember simple is best. Keep sentences short. Use a plain 0-point to 12-point font. Paragraphs no more than a few lines. Words that are comfortable & specific to the audience you are targeting. Inject subheads to break up text. Highlight important points.

    <span>7. Do You Have High YOU density?</span> Remember to you use the words YOU & YOUR to the hilt. Your reader is auto translating to ME & MINE.

    <span>8. Are you speaking intimately?</span> Can you get a strong sense of personality when you review your letter after being away from it for a while? Visualize yourself, or the character you are personifying, writing a personal letter to your perfect prospect. Never write to a crowd.

    <span>9. Are you inspiring the readers imagination?</span> You must trigger mental images with your writing. The mind has difficulty distinguishing between vividly painted word pictures, & reality. Daydreams enchant, & emotions flow in their wake.When you have emotion, you have desire. When you have desire, you have suggestibility. When you have suggestibility, you can direct action. Your levers are allegory (storytelling), metaphor, similes, verbs, adjectives, & specificity.

    <span>10. Do you offer proof?</span> Specific testimonials & convincing guarantees worked into your ad copy are essential.

    <span>11. Is your offer irresistible?</span> People are greedy, & they don’t part with their money easily. Are you piling bonuses on top of your reasons why they should part with their hard earned money, in exchange for immediate action?

    <span>12. And finally, do you have a killer P.S.?</span> For some reason, the P.S. at the bottom of a sales letter gets read a lot. Make it stop your reader in their tracks, like a deer in the headlights! Associate a positive outcome with taking the desired action, or a negative one with delay or inaction.So there you have it. Exercise this 12-step ad copy checklist before your sales rubber hits the road.`
    },
    {
        id: 4,
